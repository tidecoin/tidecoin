...
Tidecoin. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Tidecoin

**When configuring Tidecoin, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Tidecoin:
...
variables will be set when generating the Tidecoin buildsystem. In this case, `-DENABLE_WALLET=OFF`.
