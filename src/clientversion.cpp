 ...
 * for both tidecoind and tidecoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Tidecoin");


#include <tidecoin-build-info.h>
// The <tidecoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
std::string LicenseInfo()
{
    ...
    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i"), 2020, COPYRIGHT_YEAR).translated + " ") + "\n" +
           "\n" +
