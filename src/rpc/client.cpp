...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "fundrawtransaction", 1, "include_pqhd_origins"},
    ...
    { "walletcreatefundedpsbt", 3, "include_pqhd_origins"},
    { "walletcreatefundedpsbt", 3, "max_tx_weight"},
    { "walletcreatefundedpsbt", 4, "version" },
    { "dumpprivkey", 1, "options" },
    { "dumpprivkey", 1, "index" },
    { "getaddressinfo", 1, "options" },
    { "getaddressinfo", 1, "include_pqhd_origin" },
    { "walletprocesspsbt", 1, "sign" },
    { "walletprocesspsbt", 3, "finalize" },
    { "walletprocesspsbt", 4, "include_pqhd_origins" },
    { "descriptorprocesspsbt", 1, "descriptors"},
    { "descriptorprocesspsbt", 3, "finalize" },
    { "createpsbt", 0, "inputs" },
    ...
    { "sendall", 4, "include_pqhd_origins"},
    { "sendall", 4, "version"},
    ...
    { "bumpfee", 1, "include_pqhd_origins"},
    ...
    { "psbtbumpfee", 1, "include_pqhd_origins"},
    { "logging", 0, "include" },
    { "logging", 1, "exclude" },
