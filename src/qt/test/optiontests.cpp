...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/Tidecoin/Tidecoin-Qt.conf and all else left as default,
    // tidecoin-qt should set both -listen and -listenonion to false and start successfully.
