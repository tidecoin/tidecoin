...
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Dumpfile version is not supported. This version of tidecoin-wallet only supports version 1 dumpfiles. Got dumpfile with version %s"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Generating PQHD descriptor..."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Scheme %s is not allowed before auxpow activation (height %d)."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Unknown PQ scheme prefix."),
