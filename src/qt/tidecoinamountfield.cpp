...
#include <qt/tidecoinamountfield.moc>
    ...
    : QWidget(parent)
{
    ...
    amount->setMinimumWidth(amount->minimumSizeHint().width());
    amount->setSizePolicy(QSizePolicy::MinimumExpanding, QSizePolicy::Fixed);
