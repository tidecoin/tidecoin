...
class InvalidBlockRequestTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        coinbase_amount = block1.vtx[0].vout[0].nValue
        tx1 = create_tx_with_script(block1.vtx[0], 0, script_sig=bytes([OP_TRUE]), amount=coinbase_amount)
        tx2 = create_tx_with_script(tx1, 0, script_sig=bytes([OP_TRUE]), amount=coinbase_amount)
        ...
        tx3 = create_tx_with_script(tx2, 0, script_sig=bytes([OP_TRUE]), amount=coinbase_amount)
