...
function(extract_strings output)
  ...
  file(STRINGS "tidecoinstrings.po" text ENCODING "UTF-8")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/tidecoinstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/tidecoinstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/tidecoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/tidecoin_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/tidecoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/tidecoin_en.xlf" tidecoin_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" tidecoin_en "${tidecoin_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" tidecoin_en "${tidecoin_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/tidecoin_en.xlf" "${tidecoin_en}")
