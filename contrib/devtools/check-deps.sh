...
declare -A LIBS
LIBS[cli]="libtidecoin_cli.a"
LIBS[common]="libtidecoin_common.a"
LIBS[consensus]="libtidecoin_consensus.a"
LIBS[crypto]="libtidecoin_crypto.a"
LIBS[node]="libtidecoin_node.a"
LIBS[util]="libtidecoin_util.a"
LIBS[wallet]="libtidecoin_wallet.a"
